...
from src.gw_tbpsim.constant import PARAM_ARRAY
# Import JAX settings
...
# Test - wf gen - 1d
hp_test, hc_test = src.gw_tbpsim.waveform(PARAM_ARRAY)
print(f"hp_test.shape: {hp_test.shape}")
print(f"hc_test.shape: {hc_test.shape}")
# Test - wf normalization - 1d
hp_norm, hc_norm = src.gw_tbpsim.waveform_normed(PARAM_ARRAY)
